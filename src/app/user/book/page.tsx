...
const VEHICLES = [
  { id: "bike", lable: "Bike", Icon: Bike, desc: "Quick & affordable" },
  { id: "auto", lable: "Auto", Icon: Car, desc: "Everyday rides" },
  { id: "car", lable: "Car", Icon: Car, desc: "Comfort rides" },
  { id: "loading", lable: "Loading", Icon: Truck, desc: "small cargo" },
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-2xl overflow-visible">
              <div className="relative flex items-center gap-3 px-4 py-3.5 focus:focus-within:bg-white rounded-t-2xl transition-colors">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.8 }}
                  disabled={locating}
                  className="w-8 h-8 rounded-xl bg-zinc-300 transition-colors flex items-center justify-center flex-shrink-0"
                >
                  <LocateFixed
                    size={14}
